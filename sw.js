// Travel Manager Service Worker v3.0.5
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing Service Worker v3.0.5');
    event.waitUntil(
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating Service Worker v3.0.5');
    event.waitUntil(
        caches.keys()
            .then((cacheNames) => {
                return Promise.all(
...
console.log('[SW] Service Worker v3.0.5 loaded');
